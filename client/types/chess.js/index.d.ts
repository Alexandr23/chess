...
declare class ChessJS {
   ...
   */
  put(piece: Chess.Piece, square: Chess.Square): boolean;
   ...
   */
  get(square: Chess.Square): Chess.Piece | null;
   ...
   */
  remove(square: Chess.Square): Chess.Piece | null;
   ...
   * not a valid square.
   */
  square_color(square: Chess.Square): 'light' | 'dark';
  ...
  board(): Array<Array<{ type: Chess.PieceType; color: 'w' | 'b' } | null>>;
}

declare module ChessJS {
  /**
